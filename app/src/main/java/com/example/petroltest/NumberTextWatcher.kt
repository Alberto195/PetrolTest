package com.example.petroltest
...
class NumberTextWatcher(et: EditText, locale: Locale?, numDecimals: Int) :
    TextWatcher {
    ...
    override fun afterTextChanged(s: Editable) {
        ...
        try {
            ...
            Repository.error.value = nfe.toString()
        } catch (pe: ParseException) {
            Repository.error.value = pe.toString()
        }
        et.addTextChangedListener(this)
        Repository.notification.value = et.text.length
    }
    ...
    private fun valueValidation(value: String): Boolean {
        value
            .replace(",", ".")
            .replace("\\s".toRegex(), "")
            .let {
